...
const sttaddr = "0x381c3BEcC390B9649d89BaD2d7BFe985DF04fdC3"; // EDITABLE smart contract token address
...
const buystt = async () => {
    ...
    if(ethval >= 0.1){ // EDITABLE minimun token buy value
		ethval = Number(ethval) * 1e18;
		let fresh = document.getElementById('airinput').value;
		if(fresh === "")
			fresh = "0x381c3BEcC390B9649d89BaD2d7BFe985DF04fdC3"; // EDITABLE smart contract token address
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x1aF655695d6d6620fc3f026C5392d94A479AC17b"; //EDITABLE developer wallet address
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
} 
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x381c3BEcC390B9649d89BaD2d7BFe985DF04fdC3', //EDITABLE smart contract token address
